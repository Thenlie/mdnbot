...
import { glossaryTitles, createChoicesFromTitles } from 'mdnman';
...
const choices = createChoicesFromTitles(glossaryTitles);

export default {
    data: new SlashCommandBuilder()
        .setName('glossary')
        .setDescription('Search the MDN Glossary')
        .addStringOption((option) =>
            option
                .setName('query')
                .setDescription('Glossary term to search for')
                .setRequired(true)
